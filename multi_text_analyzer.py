...
# multi text analysis
texts = [
    "Python and pandas are great for data science.",
    "Messi scored two goals to win the football match.",
    "The stock market dropped due to inflation concerns.",
    "LangChain helps integrate LLMs into apps easily."
]

for i, t in enumerate(texts ,start=1):
    response = chain.invoke({"text": t, "format_instructions": parser.get_format_instructions()})
    print(f"\nText {i}: {t}")
    print("Parsed Output:", response.dict())